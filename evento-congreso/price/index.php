...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="Tabla de Precios de nuestra aplicación para tu congreso o evento."  />
        <meta name="keywords" content="precios, tabla de precios, aplicación, congreso, evento, oferta"  />
        ...
        <meta property="og:title" content="SmartConf. | Precios" />
        <meta property="og:description" content="Tabla de Precios de nuestra aplicación para tu congreso o evento.">
        ...
        <meta itemprop="description" content="Tabla de Precios de nuestra aplicación para tu congreso o evento.">
...
<?php include_once("analyticstracking.php") ?>
        ...
        <!-- How it works -->
        <div class="price-container section-container" id="how-it-works">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 section-description wow fadeIn">
                        <h2>Precios</h2><br class="hidden-xs"><br class="hidden-xs">
                    </div></div>
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-3 wow fadeInUp">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-footer">
                                <a href="../contact/" class="btn btn-success" role="button">Contratar</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-3 wow fadeInDown">
                    ...
                    <div class="col-xs-12 col-md-3 wow fadeInUp">
                        <div class="panel panel-success popular">
                            <div class="cnrflash">
                                <div class="cnrflash-inner">
                                    <span class="cnrflash-label">EL MAS
                                        <br>
                                        POPULAR</span>
                                </div>
                            </div>
